          ...
          <div class="sidebar sidebar-left">
              ...
              <div class="widget">
                  ...
                  <div class="input-group">
                      <input type="text" class="form-control" placeholder="Search articles…" aria-label="Search">
                      ...
                      <li class="d-flex align-items-center">
                          ...
                          <div class="post-info">
                              <h4 class="entry-title">
                                  <a href="#">We Just Completed $17.6 Million Medical Clinic In Mid-Missouri</a>
                              </h4>
                          </div>
                      </li>
        ...
        <div class="col-lg-8 mb-5 mb-lg-0 order-0 order-lg-1">
          <div class="post">
            <div class="post-media post-image">
              <img loading="lazy" src="{{asset('assets/images/news/news1.jpg')}}" class="img-fluid" alt="post-image">
            </div>
