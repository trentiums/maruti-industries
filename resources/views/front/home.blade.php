      ...
      <div class="container">
        <div class="box-slider-content">
          <div class="box-slider-text">
            ...
            <p class="box-slide-description">Flint Paper, Sandpaper, Emery Paper, Aloxide Rolls, and more – Delivered
              Across India.</p>
            <a href="#" class="btn btn-primary me-2 mb-2" data-bs-toggle="modal" data-bs-target="#callbackModal">
              Request Callback
            </a>
          ...
          <div class="ts-service-box">
            ...
            <div class="d-flex">
              ...
              <div class="ts-service-info">
                ...
                <p>
                  Flint Paper is a type of sandpaper made with a natural flint abrasive bonded to a sturdy paper
                  backing.</p>
          ...
          <div class="ts-service-box">
            ...
            <div class="d-flex">
              ...
              <div class="ts-service-info">
                ...
                <p>Coated abrasive paper for smoothing, finishing, and polishing wood, metal, and plastic surfaces.</p>
                  <a class="btn btn-primary mt-2" href="product_details.html" aria-label="service-details">
                    View Details
                  </a>
              </div>
          ...
          <div class="ts-service-box">
            ...
            <div class="d-flex">
              ...
              <div class="ts-service-info">
                ...
                <p>Emery Paper is a type of coated abrasive paper made with natural emery grains bonded to a flexible
                  <a class="btn btn-primary mt-2" href="product_details.html" aria-label="service-details">
                    View Details
                  </a>
              </div>
          ...
          <div class="ts-service-box">
            ...
            <div class="d-flex">
              ...
              <div class="ts-service-info">
                ...
                <p>Aloxide Cloth Roll is a flexible, durable abrasive material with aluminum oxide grains bonded.</p>
                  <a class="btn btn-primary mt-2" href="product_details.html" aria-label="service-details">
                    View Details
                  </a>
              </div>
          ...
          <div class="ts-service-box">
            ...
            <div class="d-flex">
              ...
              <div class="ts-service-info">
                ...
                <p>Emery Roll is a flexible abrasive material made with emery grains bonded to a sturdy cloth backing.
                </p>
                <a class="btn btn-primary mt-2" href="product_details.html" aria-label="service-details">
                  View Details
                </a>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 text-center">
          <img loading="lazy" class="img-fluid" src="{{asset('assets/images/services/service-center.jpg')}}" alt="service-avater-image" height="100px" width="200px">
        </div><!-- Col end -->
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 ts-facts mb-4">
            <div class="ts-facts-img mb-2">
              <img loading="lazy" src="{{asset('assets/images/icon-image/fact1.png')}}" alt="Automotive">
            </div>
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 ts-facts mb-4">
            <div class="ts-facts-img mb-2">
              <img loading="lazy" src="{{asset('assets/images/icon-image/fact2.png')}}" alt="Woodworking">
            </div>
            <div class="ts-facts-content text-center">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 ts-facts mb-4">
            <div class="ts-facts-img mb-2">
              <img loading="lazy" src="{{asset('assets/images/icon-image/fact3.png')}}" alt="Metal Fabrication">
            </div>
            <div class="ts-facts-content text-center">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 ts-facts mb-4">
            <div class="ts-facts-img mb-2">
              <img loading="lazy" src="{{asset('assets/images/icon-image/fact4.png')}}" alt="Construction">
            </div>
            <div class="ts-facts-content text-center">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 ts-facts mb-4">
            <div class="ts-facts-img mb-2">
              <img loading="lazy" src="{{asset('assets/images/icon-image/fact4.png')}}" alt="Retail Tools & Hardware">
            </div>
            <div class="ts-facts-content text-center">
          ...
          <div class="col-lg-2 col-md-4 col-sm-6 ts-facts mb-4">
            <div class="ts-facts-img mb-2">
              <img loading="lazy" src="{{asset('assets/images/icon-image/fact4.png')}}" alt="Marine Industry">
            </div>
            <div class="ts-facts-content text-center">
...
<div class="container">
  <div class="row">
    ...
    <div class="col-lg-4 col-md-6 mb-5 mt-5">
      <div class="ts-service-box">
          <div class="ts-service-image-wrapper">
            <img loading="lazy" class="w-100" src="{{asset('assets/images/team/team1')}}.jpg" alt="service-image">
          </div>
          <div class="d-flex">
  ...
  Read More
    ...
    <div class="col-lg-4 col-md-6 mb-5 mt-5">
      <div class="ts-service-box">
          <div class="ts-service-image-wrapper">
            <img loading="lazy" class="w-100" src="{{asset('assets/images/team/team2')}}.jpg" alt="service-image">
          </div>
          <div class="d-flex">
  ...
  Read More
    ...
    <div class="col-lg-4 col-md-6 mb-5 mt-5">
      <div class="ts-service-box">
          <div class="ts-service-image-wrapper">
            <img loading="lazy" class="w-100" src="{{asset('assets/images/team/team4')}}.jpg" alt="service-image">
          </div>
          <div class="d-flex">
      ...
      <div class="row">
       ...
       <!-- 
        ...
        <div class="col-md-6 text-center text-md-right mt-3 mt-md-0 gap-5">
          <div class="call-to-action-btn d-flex flex-column flex-md-row justify-content-center justify-content-md-end">
            <a href="#" class="btn btn-primary mb-2 mb-md-0 me-md-2" data-bs-toggle="modal" data-bs-target="#callbackModal">
              Request Callback
            </a>
            ...
            <a href="https://wa.me/1234567890" target="_blank">
              <img src="{{asset('assets/images/whatsapp.png')}}" alt="WhatsApp" class="mt-2 mt-md-0" />
            </a>
          </div>
        </div>
