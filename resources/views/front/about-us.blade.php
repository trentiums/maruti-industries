    ...
    <div class="container">
      <div class="row">
          <div class="col-lg-6">
            ...
            <p>
              <strong>Maruti Industries</strong> is a trusted name in the field of abrasives, dedicated to delivering reliable, high-performance solutions for industries across India. With a focus on quality and consistency, we manufacture and supply a wide range of abrasive products including Flint Paper, Sandpaper, Emery Paper, and Aloxide Rolls.
            </p>
            <p>
              Built on a foundation of innovation and customer satisfaction, our solutions support furniture manufacturers, fabrication units, auto body workshops, paint shops, and construction supply chains. Every product we create is engineered with precision to meet the rigorous demands of industrial finishing and surface preparation.
            </p>
      ...
      <div class="row justify-content-center">
        ...
        <div class="col-md-5 col-sm-12 mb-4">
          <div class="p-4 shadow rounded h-100 text-center bg-white">
            ...
            <p>To provide superior abrasive products that help manufacturers, craftsmen, and industries achieve precision finishing with reliability and efficiency.</p>
          </div>
        </div>
        ...
        <div class="col-md-5 col-sm-12 mb-4">
          <div class="p-4 shadow rounded h-100 text-center bg-white">
            ...
            <p>To be recognized as the most trusted name in abrasives by delivering unmatched product quality and customer service.</p>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row text-center">
        ...
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="core-box p-4 shadow rounded bg-light h-100">
            <div class="core-icon mb-3">
              <img src="{{asset('assets/images/bulk-buy')}}ing.png" alt="Quality Control" style="height: 50px;">
            </div>
        ...
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="core-box p-4 shadow rounded bg-light h-100">
            <div class="core-icon mb-3">
              <img src="{{asset('assets/images/bulk-buy')}}ing.png" alt="Grit Sizes" style="height: 50px;">
            </div>
        ...
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="core-box p-4 shadow rounded bg-light h-100">
            <div class="core-icon mb-3">
              <img src="{{asset('assets/images/bulk-buy')}}ing.png" alt="Delivery" style="height: 50px;">
            </div>
        ...
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="core-box p-4 shadow rounded bg-light h-100">
            <div class="core-icon mb-3">
              <img src="{{asset('assets/images/delivery')}}-icon.jpg" alt="Custom Cut" style="height: 50px;">
            </div>
        ...
        <div class="col-md-4 col-sm-6 mb-4">
          <div class="core-box p-4 shadow rounded bg-light h-100">
            <div class="core-icon mb-3">
              <img src="{{asset('assets/images/grit.png')}} "alt="Trusted Clients" style="height: 50px;">
            </div>
          ...
          <div class="col-lg-12">
            <div id="team-slide" class="team-slide">
                <div class="item">
                  <div class="ts-team-wrapper">
                      <div class="team-img-wrapper">
                        <img loading="lazy" class="w-100" src="{{asset('assets/images/team/team1.jpg')}}" alt="team-img">
                      </div>
                ...
                <div class="item">
                  <div class="ts-team-wrapper">
                      <div class="team-img-wrapper">
                        <img loading="lazy" class="w-100" src="{{asset('assets/images/team/team2.jpg')}}" alt="team-img">
                      </div>
                      <div class="ts-team-content">
                ...
                <div class="item">
                  <div class="ts-team-wrapper">
                      <div class="team-img-wrapper">
                        <img loading="lazy" class="w-100" src="{{asset('assets/images/team/team3.jpg')}}" alt="team-img">
                      </div>
                      <div class="ts-team-content">
                ...
                <div class="item">
                  <div class="ts-team-wrapper">
                      <div class="team-img-wrapper">
                        <img loading="lazy" class="w-100" src="{{asset('assets/images/team/team4.jpg')}}" alt="team-img">
                      </div>
                      <div class="ts-team-content">
                ...
                <div class="item">
                  <div class="ts-team-wrapper">
                      <div class="team-img-wrapper">
                        <img loading="lazy" class="w-100" src="{{asset('assets/images/team/team5.jpg')}}" alt="team-img">
                      </div>
                      <div class="ts-team-content">
                ...
                <div class="item">
                  <div class="ts-team-wrapper">
                      <div class="team-img-wrapper">
                        <img loading="lazy" class="w-100" src="{{asset('assets/images/team/team6.jpg')}}" alt="team-img">
                      </div>
                      <div class="ts-team-content">
