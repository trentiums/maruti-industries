    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.inquiries.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_interest') ? 'is-invalid' : '' }}" type="text" name="product_intrest" id="product_intrest" value="{{ old('product_interest', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('qty') ? 'is-invalid' : '' }}" type="number" name="qty" id="qty" value="{{ old('qty', '') }}">
                @if($errors->has('qty'))
                    <div class="invalid-feedback">
                        {{ $errors->first('qty') }}
                    </div>
                @endif
                <span class="help-block">{{ trans('cruds.inquiry.fields.qty_helper') }}</span>
            </div>
            <div class="form-group">
