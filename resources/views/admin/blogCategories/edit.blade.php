    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.blog-categories.update", [$blogCategory->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('small_description') ? 'is-invalid' : '' }}" name="small_description" id="small_description" required>{{ old('small_description', $blogCategory->small_description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('long_description') ? 'is-invalid' : '' }}" name="long_description" id="long_description">{!! old('long_description', $blogCategory->long_description) !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meta_title') ? 'is-invalid' : '' }}" type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $blogCategory->meta_title) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" name="meta_description" id="meta_description">{{ old('meta_description', $blogCategory->meta_description) }}</textarea>
